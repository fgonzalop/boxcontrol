...
void setup() {
  ...
  EEPROM.write(RELAY_INDEX+5, THE_RELAY_4);
  EEPROM.write(RELAY_INDEX+6, THE_RELAY_5);
  EEPROM.write(RELAY_INDEX+7, THE_RELAY_6);
  EEPROM.write(RELAY_INDEX+8, THE_RELAY_7);
  EEPROM.write(RELAY_INDEX+9, THE_RELAY_8);
